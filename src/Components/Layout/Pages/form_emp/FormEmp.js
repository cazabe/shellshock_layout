...
const FormEmp = ({ history }) => {
    ...
    const [fotoNombramiento, setFotoNombramiento] = useState("");
    //car
    ...
    const handleSubmit = async (e) => {
        ...
        formTagData.append("fotoNombramiento", fotoNombramiento);
    ...
    return (
        <Container>
            ...
            <Form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <FormGroup className="mb-4">
                    <Label for="examplePassword">Suba una foto clara o escanee el nombramiento del Representante Legal </Label>
                    <Input type="file" onChange={(e) => setFotoNombramiento(e.target.files[0])} required />
                </FormGroup>
